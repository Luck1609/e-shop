...
export function TypographyH1({ children, className }: IProps) {
  return (
    <h1
      className={cn(
        "text-4xl font-extrabold lg:text-5xl text-light-heading dark:text-dark-text",
        className
      )}
    >
      {children}
...
export function TypographyH2({ children, className }: IProps) {
  return (
    <h2
      className={cn(
        "pb-2 text-34xl lg:text-4xl font-semibold first:mt-0 text-light-heading dark:text-dark-text",
        className
      )}
    >
      {children}
